...
```shell-session
Luis Miguel Jaime Hernandez@htb[/htb]$ curl -I https://www.inlanefreight.com
...
```shell-session
Luis Miguel Jaime Hernandez@htb[/htb]$ curl https://www.inlanefreight.com -A 'Mozilla/5.0'
