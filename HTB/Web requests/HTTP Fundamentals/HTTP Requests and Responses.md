...
```shell-session
Luis Miguel Jaime Hernandez@htb[/htb]$ curl inlanefreight.com -v
...
![devtools_network_requests](https://academy.hackthebox.com/storage/modules/35/devtools_network_requests.jpg)
