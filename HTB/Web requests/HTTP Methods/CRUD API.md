...
```shell-session
Luis Miguel Jaime Hernandez@htb[/htb]$ curl http://<SERVER_IP>:<PORT>/api.php/city/london
...
```shell-session
Luis Miguel Jaime Hernandez@htb[/htb]$ curl -s http://<SERVER_IP>:<PORT>/api.php/city/london | jq
...
```shell-session
Luis Miguel Jaime Hernandez@htb[/htb]$ curl -s http://<SERVER_IP>:<PORT>/api.php/city/le | jq
...
```shell-session
Luis Miguel Jaime Hernandez@htb[/htb]$ curl -s http://<SERVER_IP>:<PORT>/api.php/city/ | jq
...
```shell-session
Luis Miguel Jaime Hernandez@htb[/htb]$ curl -X POST http://<SERVER_IP>:<PORT>/api.php/city/ -d '{"city_name":"HTB_City", "country_name":"HTB"}' -H 'Content-Type: application/json'
```

Now, we can read the content of the city we added (`HTB_City`), to see if it was successfully added:

```shell-session
Luis Miguel Jaime Hernandez@htb[/htb]$ curl -s http://<SERVER_IP>:<PORT>/api.php/city/HTB_City | jq
...
```shell-session
Luis Miguel Jaime Hernandez@htb[/htb]$ curl -X PUT http://<SERVER_IP>:<PORT>/api.php/city/london -d '{"city_name":"New_HTB_City", "country_name":"HTB"}' -H 'Content-Type: application/json'
```
...
```shell-session
Luis Miguel Jaime Hernandez@htb[/htb]$ curl -s http://<SERVER_IP>:<PORT>/api.php/city/New_HTB_City | jq
...
```shell-session
Luis Miguel Jaime Hernandez@htb[/htb]$ curl -X DELETE http://<SERVER_IP>:<PORT>/api.php/city/New_HTB_City
```
...
* curl -X PUT http://167.99.95.55:30984/api.php/city/portland -H 'Content-Type: application/json' -d '{"city_name":"flag", "country_name":"HTB"}'
* curl -X DELETE http://167.99.95.55:30984/api.php/city/baltimore
* curl -v http://167.99.95.55:30984/api.php/city/flag | jq
