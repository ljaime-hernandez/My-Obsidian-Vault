...
```shell-session
Luis Miguel Jaime Hernandez@htb[/htb]$ sudo service postgresql status
...
```shell-session
Luis Miguel Jaime Hernandez@htb[/htb]$ sudo systemctl start postgresql
```
...
```shell-session
Luis Miguel Jaime Hernandez@htb[/htb]$ sudo msfdb init
...
```shell-session
Luis Miguel Jaime Hernandez@htb[/htb]$ sudo msfdb status
...
```shell-session
Luis Miguel Jaime Hernandez@htb[/htb]$ sudo msfdb run
...
```shell-session
Luis Miguel Jaime Hernandez@htb[/htb]$ msfdb reinit
Luis Miguel Jaime Hernandez@htb[/htb]$ cp /usr/share/metasploit-framework/config/database.yml ~/.msf4/
Luis Miguel Jaime Hernandez@htb[/htb]$ sudo service postgresql restart
Luis Miguel Jaime Hernandez@htb[/htb]$ msfconsole -q
...
```shell-session
Luis Miguel Jaime Hernandez@htb[/htb]$ cat Target.nmap
