...
```shell-session
Luis Miguel Jaime Hernandez@htb[/htb]$ git clone https://github.com/darkoperator/Metasploit-Plugins
Luis Miguel Jaime Hernandez@htb[/htb]$ ls Metasploit-Plugins
...
```shell-session
Luis Miguel Jaime Hernandez@htb[/htb]$ sudo cp ./Metasploit-Plugins/pentest.rb /usr/share/metasploit-framework/plugins/pentest.rb
```
