...
```shell-session
Luis Miguel Jaime Hernandez@htb[/htb]$ searchsploit nagios3
...
```shell-session
Luis Miguel Jaime Hernandez@htb[/htb]$ searchsploit -t Nagios3 --exclude=".py"
...
```shell-session
Luis Miguel Jaime Hernandez@htb[/htb]$ ls /usr/share/metasploit-framework/
...
```shell-session
Luis Miguel Jaime Hernandez@htb[/htb]$ ls .msf4/
...
```shell-session
Luis Miguel Jaime Hernandez@htb[/htb]$ cp ~/Downloads/9861.rb /usr/share/metasploit-framework/modules/exploits/unix/webapp/nagios3_command_injection.rb
Luis Miguel Jaime Hernandez@htb[/htb]$ msfconsole -m /usr/share/metasploit-framework/modules/
```
...
```shell-session
Luis Miguel Jaime Hernandez@htb[/htb]$ ls /usr/share/metasploit-framework/modules/exploits/linux/http/ | grep bludit

bludit_upload_images_exec.rb
```

```shell-session
Luis Miguel Jaime Hernandez@htb[/htb]$ cp ~/Downloads/48746.rb /usr/share/metasploit-framework/modules/exploits/linux/http/bludit_auth_bruteforce_mitigation_bypass.rb
```
