...
```shell-session
Luis Miguel Jaime Hernandez@htb[/htb]$ sudo mkdir /etc/systemd/system/mytimer.timer.d
Luis Miguel Jaime Hernandez@htb[/htb]$ sudo vim /etc/systemd/system/mytimer.timer
```
...
```shell-session
Luis Miguel Jaime Hernandez@htb[/htb]$ sudo vim /etc/systemd/system/mytimer.service
```
...
```shell-session
Luis Miguel Jaime Hernandez@htb[/htb]$ sudo systemctl daemon-reload
```
...
```shell-session
Luis Miguel Jaime Hernandez@htb[/htb]$ sudo systemctl start mytimer.service
Luis Miguel Jaime Hernandez@htb[/htb]$ sudo systemctl enable mytimer.service
```
