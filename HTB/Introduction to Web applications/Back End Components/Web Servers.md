...
```shell-session
Luis Miguel Jaime Hernandez@htb[/htb]$ curl -I https://academy.hackthebox.com
...
```shell-session
Luis Miguel Jaime Hernandez@htb[/htb]$ curl https://academy.hackthebox.com
...
`Created`
Look on https://www.restapitutorial.com/httpstatuscodes.html
