...
```shell-session
Luis Miguel Jaime Hernandez@htb[/htb]$ sudo openvpn ./htb.ovpn
...
```shell-session
Luis Miguel Jaime Hernandez@htb[/htb]$ ip -4 a show tun0
...
```shell-session
Luis Miguel Jaime Hernandez@htb[/htb]$ sudo netstat -rn
...
```shell-session
Luis Miguel Jaime Hernandez@htb[/htb]$ ping -c 4 10.10.14.1
...
```shell-session
Luis Miguel Jaime Hernandez@htb[/htb]$ ssh-keygen
