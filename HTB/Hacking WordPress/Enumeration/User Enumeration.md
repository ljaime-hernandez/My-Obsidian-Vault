...
```shell-session
KaoruRyusaki@htb[/htb]$ curl -s -I http://blog.inlanefreight.com/?author=1
...
```shell-session
KaoruRyusaki@htb[/htb]$ curl -s -I http://blog.inlanefreight.com/?author=100
...
```shell-session
KaoruRyusaki@htb[/htb]$ curl http://blog.inlanefreight.com/wp-json/wp/v2/users | jq
