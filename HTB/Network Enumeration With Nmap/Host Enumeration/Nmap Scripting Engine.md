...
```shell-session
Luis Miguel Jaime Hernandez@htb[/htb]$ sudo nmap <target> -sC
```

#### Specific Scripts Category

```shell-session
Luis Miguel Jaime Hernandez@htb[/htb]$ sudo nmap <target> --script <category>
```

#### Defined Scripts

```shell-session
Luis Miguel Jaime Hernandez@htb[/htb]$ sudo nmap <target> --script <script-name>,<script-name>,...
```
...
```shell-session
Luis Miguel Jaime Hernandez@htb[/htb]$ sudo nmap 10.129.2.28 -p 25 --script banner,smtp-commands
...
```shell-session
Luis Miguel Jaime Hernandez@htb[/htb]$ sudo nmap 10.129.2.28 -p 80 -A
...
```shell-session
Luis Miguel Jaime Hernandez@htb[/htb]$ sudo nmap 10.129.2.28 -p 80 -sV --script vuln 
