...
* Run command on the designated cmd server " where.exe /R C:\ waldo.txt "
* Move to the proper directory with the command " chdir C:\'Documents and Settings'\MTanaka\Favorites\ "
* Run command " type waldo.txt "
