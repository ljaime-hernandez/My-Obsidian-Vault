...
```shell-session
Luis Miguel Jaime Hernandez@htb[/htb]$ cat /etc/snmp/snmpd.conf | grep -v "#" | sed -r '/^\s*$/d'
...
```shell-session
Luis Miguel Jaime Hernandez@htb[/htb]$ snmpwalk -v2c -c public 10.129.14.128
...
```shell-session
Luis Miguel Jaime Hernandez@htb[/htb]$ sudo apt install onesixtyone
Luis Miguel Jaime Hernandez@htb[/htb]$ onesixtyone -c /opt/useful/SecLists/Discovery/SNMP/snmp.txt 10.129.14.128
...
```shell-session
Luis Miguel Jaime Hernandez@htb[/htb]$ sudo apt install braa
Luis Miguel Jaime Hernandez@htb[/htb]$ braa <community string>@<IP>:.1.3.6.*   # Syntax
Luis Miguel Jaime Hernandez@htb[/htb]$ braa public@10.129.14.128:.1.3.6.*
